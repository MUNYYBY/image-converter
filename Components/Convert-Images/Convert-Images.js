...
import ConvertingPhase from "../converting-phase/converting-phase";
        ...
        <>
          <Container>
            <Row className="justify-content-center align-items-center py-4">
              ...
              <Col md={10} sm={10}>
                <h4 className="text-center">lorem ipsum lorem ipsum </h4>
              </Col>
              <Col md={10} sm={10}>
                  ...
                  <div className="Upload-Images-pit-content-container d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div className="choose-files-container d-flex flex-column justify-content-center align-items-center w-75">
                      ...
                      <p className="text-center mt-2">
                        Upload your image or drag and drop (max size 20 mb) You
                        can convert up-to 10 images at a time
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <Accordion flush className="rounded shadow">
                  ...
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                      ...
                      Duis aute irure dolor in reprehenderit in proident, sunt
